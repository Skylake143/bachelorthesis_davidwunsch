...
if __name__ == "__main__":
    ...
    def convert_last_layer(network, num_classes=100, hidden_size = 2048):
    ...
    experiment_tracker.initialize_new_experiment(f"TL{retraining_layers}_MLP3BatchDropout", training_parameters=training_parameters | training_objects)
