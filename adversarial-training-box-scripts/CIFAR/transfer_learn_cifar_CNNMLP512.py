...
# Add this class definition before your main function
...
if __name__ == "__main__":
    ...
    experiment_tracker.initialize_new_experiment(f"TL{retraining_layers}_512ConvMLP", training_parameters=training_parameters | training_objects)
