...
if __name__ == "__main__":
    ...
    def convert_last_layer(network, num_classes=47, hidden_size=200):
        ...
        # Create a small MLP with one hidden layer
        new_mlp = nn.Sequential(
            nn.Linear(in_features, hidden_size, bias=has_bias),
            nn.ReLU(),
            nn.Linear(hidden_size, num_classes, bias=has_bias)
        )
