...
if __name__ == "__main__":
   ...
   # Dataloaders
    ...
    training_stack = []
    training_stack.append((20, StandardTrainingModule(criterion=criterion, attack=PGDAttack(epsilon_step_size=0.01, number_iterations=40, random_init=True), epsilon=0.3)))
    ...
    experiment_tracker.initialize_new_experiment(f"TL{retraining_layers}_Adversarial", training_parameters=training_parameters | training_objects)
